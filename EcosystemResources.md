...
* [Deep Blue Alpha](https://deepbluealpha.io) - Real-time Ethereum whale wallet tracker with buy/sell DEX swap classification across 12,000+ wallets, Whale Sentiment Index, per-token net flow analysis, and a free public API. No signup required for the free tier.
### Knowledge/Education
